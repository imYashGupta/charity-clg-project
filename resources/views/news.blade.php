                        ...
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__title">
                                    <h3><a href="{{route("page.news")}}">How Does Malnutrition Affect Children?</a></h3>
                                </div>
                                <a href="{{route("page.news")}}" class="thm-btn news-one__btn">More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__title">
                                    <h3><a href="{{route("page.news")}}">Capitalize on low hanging fruit to identify</a></h3>
                                </div>
                                <a href="{{route("page.news")}}" class="thm-btn news-one__btn">More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__title">
                                    <h3><a href="{{route("page.news")}}">Override the digital divide with additional</a></h3>
                                </div>
                                <a href="{{route("page.news")}}" class="thm-btn news-one__btn">More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__title">
                                    <h3><a href="{{route("page.news")}}">Nanotechnology immersion along the</a></h3>
                                </div>
                                <a href="{{route("page.news")}}" class="thm-btn news-one__btn">More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__title">
                                    <h3><a href="{{route("page.news")}}">User generated content in real will have
                                            multiple</a></h3>
                                </div>
                                <a href="{{route("page.news")}}" class="thm-btn news-one__btn">More</a>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        ...
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <div class="news-one__title">
                                    <h3><a href="{{route("page.news")}}"> Iterative approaches to corporate strategy</a></h3>
                                </div>
                                <a href="{{route("page.news")}}" class="thm-btn news-one__btn">More</a>
                            </div>
                        </div>
